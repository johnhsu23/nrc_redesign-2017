...
<div id="pageContentContainer" class="nrc_pageContentContainer nrc-report"><!-- container -->
   <article class="row row-eq-height">
      <section id="pageContent" class="col-md-8 nrc_pageContent">
         ...
         <p>Select a <span>jurisdiction</span> and a <span>result</span> to see how students performedon the latest NAEP assessments.</p>
         <p>Click on the <i class="fa fa-question-circle" aria-hidden="true"></i> to see the most recent reports in each subject</p>
