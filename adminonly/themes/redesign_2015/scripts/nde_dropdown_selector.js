...
function changejurd() {
	switch($j('#jurdid').parent().find('span').text())
	{
		...
		case "All Districts":
			jurisdiction = "NP,NL,XQ,XA,XU,XM,XB,XT,XC,XV,XS,XR,XW,XE,XF,XO,XH,XJ,XL,XI,XK,XN,XP,XD"
			break;
	}
}
	...
	else
	{
		switch($j('#downloadsubject').parent().find('span').attr('title'))
		{
			...
			case "MATHTUDA": 
				...
				break;
			case "MATH12": 
				window.location = "/reading_math_g12_2015/files/Appendix_2015_Math_G12." + getExcelExtension(fileType);
				break;
			case "READNS": 
			...
			case "READTUDA": 
				...
				break;
			case "READ12": 
				window.location = "/reading_math_g12_2015/files/Appendix_2015_Reading_G12." + getExcelExtension(fileType);
				break;
			case "TEL": 
				window.location = "/tel_2014/files/2014_TEL_Appendix_Tables." + fileType;
				break;
			case "SCI":
				window.location = "/science_2015/files/2015_science_Results_Appendix." + getExcelExtension(fileType);
				break;
			case "HIS": 
