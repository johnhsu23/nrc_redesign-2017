...
<p>Main NAEP assesses representative samples of private school students at grades 4, 8, and 12. Private school results are reported whenever at least 70 percent of the schools in the sample participate. The symbol ‡ shows up in the tables or charts whenever the data could not be reported.</p>

<p>For a quick but detailed look at results for private and public schools, use the Private School Quick Data tool below. Select:</p>

<ul>
<li>subject and grade,</li>
<li>data broken out by</li>
	<ul>
    	<li>two categories (public and private schools); or by</li>
        <li>five categories (adding Catholic, other private schools, Bureau of Indian Education schools, and the Department of Defense Education Activity schools); or by</li>
        <li>seven categories (adding Conservative Christian and Lutheran) -- only in mathematics and reading (grades 4, 8) or writing (grade 8).</li>
    </ul>
</ul>
<p>After completing selections, press "show table." This will take you to a results table in the NAEP Data Explorer (NDE), in a new tab or window.</p>
	...
	<form name="nde_selector" id="nde_selector">
		...
		<div style="text-align: right; margin-left: 10em; width:22em;">
			<select name="variid" id="variid" onchange="changevari(this);">
                ...
                <option>Public or nonpublic school (7 category)</option>
			</select>
			<br />
